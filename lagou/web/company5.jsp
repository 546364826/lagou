        ...
        <div class="content_mid">
            <dl class="c_section c_section_mid">
                ...
                <dd>
                    ...
                    <form action="${pageContext.request.contextPath }/AddIntroduceServlet?method=doPost" method="post" >
                    	<input type="hidden" name="companynId" value="25927">
                        <h3>公司介绍</h3> 
                        <textarea placeholder="请分段详细描述公司简介、企业文化等" name="culture" ></textarea>
                        <div class="word_count">你还可以输入 <span>1000</span> 字</div>
                    	<div class="clear"></div>
                    	<input type="submit"  value="保存，完成" class="btn_big fr">
                    </form>
                </dd>
            </dl>
       	</div>
