        ...
        <div class="content_mid">
            <dl class="c_section c_section_mid">
                ...
                <dd>
                    ...
                    <form action="${pageContext.request.contextPath }/AddTeamServlet?method=doPost" method="post">
	                    ...
	                    <div id="memberDiv">
		                        ...
		                        <h3>创始人姓名</h3>
		                        <input type="text" placeholder="请输入创始人姓名" name="founder" id="name0" class="s_input1 valid">
		                        
		                        <h3>当前职位</h3>
		                        <input type="text" placeholder="请输入当前职位，如：创始人兼CEO" name="position" id="position0" class="s_input1 valid">
		                        
		                        <h3>新浪微博</h3>
		                        <input type="text" placeholder="请输入创始人新浪微博地址" name="weibo" id="weibo0">
		                        
		                        <h3>创始人简介</h3> 
		                        <textarea placeholder="请输入该创始人的个人履历等，建议按照时间倒序分条展示" maxlength="1000" name="Introduction" id="description0"></textarea>
                    	...
                    	<a class="btn_cancel fr" href="company4.jsp">跳过</a>
                    </form>
                </dd>
            </dl>
       	</div>
