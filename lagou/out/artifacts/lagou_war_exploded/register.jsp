...
<div class="login_wrapper">
    ...
    <div class="login_box">
        <form id="loginForm" action="${pageContext.request.contextPath }/AddUsersServlet?method=doPost"  method="post">
            <ul class="register_radio clearfix">
                <li>
                    找工作
                    <input type="radio" value="0" name="purpose" />
                </li>
                <li>
                    招人
    ...
    $(document).ready(function(e) {
        ...
        $("#loginForm").validate({
            ...
            errorPlacement:function(label, element){/*
                ...
                /*modify nancy*/
                if(element.attr("purpose") == "radio"){
                    label.insertAfter($(element).parents('ul')).css('marginTop','-20px');
                }else if(element.attr("purpose") == "checkbox"){
