        ...
        <div class="content_mid">
            <dl class="c_section c_section_mid">
                ...
                <dd id="step2Form">
	                    ...
	                    <form action="${pageContext.request.contextPath }/AddLablesServlet?method=doPost"  method="post">
	                    <h3>已添加标签</h3>
	                    <ul class="reset" id="labels"></ul>

	                    <input type="text" placeholder="请输入自定义标签" name="lable" id="lable">
	                    ...
	                    <a class="btn_cancel fr" href="company3.jsp">跳过</a>
                        </form>
                </dd>
            </dl>
       	</div>
