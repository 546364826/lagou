...
<link href="../style/css/external.min.css" type="text/css"
	rel="stylesheet">
			...
			<div class="wrapper">
				...
				<dl class="collapsible_menu">
					<dt>
						...
						</span> <span class="red dn" id="noticeDot-1"></span>
						<i></i>
					</dt>
					...
					<dd class="logout" style="display: none;">
						<a rel="nofollow" href="../index.jsp">退出</a>
					</dd>
				</dl>
			</div>
		</div>
			...
			<div class="content">
				<dl class="company_center_content">
					...
					<dd>
						...
						<form action="${pageContext.request.contextPath }/PositionServlet?method=addJob"
								...
								<tbody>
									...
									<tr>
										...
										<td><span class="c9 f14">(建议分条描述工作职责等。请勿输入公司邮箱、联系电话及其他外链，否则将自动删除)</span>
											<textarea rows="" cols="" name="positionDetail"></textarea>
										</td>
									</tr>
									<tr>
										<td><span class="redstar">*</span></td>
								...
								<tbody>
									...
									<tr>
										...
										<td colspan="2"><input type="submit" value="预览"
											...
											value="发布" id="formSubmit1" class="btn_32"></td>
									</tr>
								</tbody>
							</table>
						</form>
			...
			<div style="display: none;">
				...
				<div class="popup" id="baiduMap">
					...
					<div id="allmap"
						...
						<div
							style="position: absolute; z-index: 1201; top: 10px; right: 10px; width: 17px; height: 16px; background: url(/style/images/img/node.gif) no-repeat scroll 0% 0% transparent; cursor: pointer; display: none;"
						title="退出全景"></div>
						<div
