        ...
        <div class="content_mid">
            <dl class="c_section c_section_mid">
                ...
                <dd>
                    ...
                    <form action="${pageContext.request.contextPath }/AddProductServlet?method=doPost" method="post" enctype="multipart/form-data">
                    	...
                    	<div id="productDiv">
		                    <div class="formWrapper">
		                        ...
		                        <h3>产品海报</h3>
			                        <input type="file" title="支持jpg、jpeg、gif、png格式，文件小于5M" onchange="img_check(this,'http://www.lagou.com/c/upload.json',380,220,5,'myfiles0','myfiles0_error','productNo0','productShow0','type0','productInfos0');" name="posters" id="myfiles0" accept="image/*">
		                        ...
		                        <h3>产品名称</h3>
		                        <input type="text" placeholder="请输入产品名称" name="name" id="name0">
		                        
		                        <h3>产品地址</h3>
		                        <input type="text" placeholder="请输入产品主页URL或产品下载地址" name="address" id="address0">
		                        
		                        <h3>产品简介</h3> 
		                        <textarea placeholder="请简短描述该产品定位、产品特色、用户群体等" maxlength="1000" name="Introduction" id="description0"></textarea>
                    	...
                    	<a class="btn_cancel fr" href="http://www.lagou.com/c/intro.html">跳过</a>
                    </form>
                </dd>
            </dl>
       	</div>
